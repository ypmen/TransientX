...
. It produces candidate plots in PNG format and generates a candidate list. The options are described in detail in the :doc:`usage/transientx_fil <usage/transientx_fil>`.

replot_fil
~~~~~~~~~~~~~~~~
A tool to reprocess candidates generated by transientx_fil. It removes duplicate and bad candidates based on multiple criteria, and can generate archive files for further analysis.
